...
import (
	...
	"github.com/emag3m/reputation/x/reputation"
)
...
var (
	...
	DefaultCLIHome = os.ExpandEnv("$HOME/.reputationCLI")

	// DefaultNodeHome sets the folder where the applcation data and configuration will be stored
	DefaultNodeHome = os.ExpandEnv("$HOME/.reputationD")
...
// NewInitApp is a constructor function for reputationApp
func NewInitApp(logger log.Logger, db dbm.DB, traceStore io.Writer, loadLatest bool,
	...
	keys := sdk.NewKVStoreKeys(bam.MainStoreKey, auth.StoreKey, staking.StoreKey,
		supply.StoreKey, distr.StoreKey, slashing.StoreKey, params.StoreKey, reputation.StoreKey)
	...
	app.mm = module.NewManager(
		...
		reputation.NewAppModule(app.reputationKeeper, app.bankKeeper),
